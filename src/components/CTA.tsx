...
export const CTA = () => {
  return (
    <section className="relative bg-gray-50 pb-0 -mb-32 -mt-40">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-6xl mx-auto z-20">
          ...
          <div className="relative bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-200">
            ...
            <div className="absolute -top-32 -left-32 w-96 h-96 bg-gradient-to-br from-purple-300 via-blue-300 to-purple-200 rounded-full blur-3xl opacity-60"></div>
            
            {/* Bottom-Right Gradient Blob */}
            <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-gradient-to-tl from-purple-300 via-pink-200 to-blue-200 rounded-full blur-3xl opacity-50"></div>
            
            {/* Center subtle glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-64 bg-gradient-to-r from-purple-100 via-blue-100 to-purple-100 blur-3xl opacity-30"></div>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-xl mx-auto pt-2">
                  <Input 
                    ...
                    className="h-14 text-base bg-white border-0 shadow-lg flex-1"
                  />
                  <Button 
                    size="lg" 
                ...
                <div className="flex items-center justify-center gap-3 pt-2 pb-6">
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4, 5].map((i) => (
                      <div 
                        key={i} 
                        className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-purple-600 border-2 border-white shadow-lg"
                      />
                    ))}
                  </div>
