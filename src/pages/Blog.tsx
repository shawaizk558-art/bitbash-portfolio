              ...
              {featuredPosts.length > 0 && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
                  {featuredPosts.map((post) => (
                    <article
                      key={post.id}
                      className="bg-white rounded-xl overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow duration-300 group cursor-pointer"
                    >
                      {/* Featured Image */}
                      ...
                      <div className="p-6 sm:p-8">
                        ...
                        <a
                          href={`/blog/${post.slug}`}
                          className="inline-flex items-center gap-2 text-purple-600 font-semibold hover:text-purple-700 transition-colors text-base"
                        >
                          Read more
                  ...
                  {regularPosts.map((post) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <a
                          href={`/blog/${post.slug}`}
                          className="inline-flex items-center gap-2 text-purple-600 font-semibold hover:text-purple-700 transition-colors text-sm sm:text-base"
                        >
                          Read more
                          <ArrowRight className="w-4 h-4" />
                        </a>
