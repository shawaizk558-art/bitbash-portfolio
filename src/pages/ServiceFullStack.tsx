...
const cardKey = (title: string, index: number) => `fullstack-${index}-${title}`;
        ...
        <div className="max-w-screen-xl mx-auto px-4 space-y-6">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-base text-gray-700 max-w-2xl leading-[1.65]">
              Full-stack product patterns and vertical builds delivered as cohesive systems.
            </p>
          </div>
          <div className="columns-1 md:columns-2 gap-6 sm:gap-7 [column-fill:_balance]">
            {fullStackCategories.map((category, index) => {
            ...
            {fullStackCategories.length % 2 === 0 && (
